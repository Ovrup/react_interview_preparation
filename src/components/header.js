...
export default function Header() {
  return (
    <div className="header">
      ...
      <Link className="link" to="/login-mobile">
        <div className="header-card">
      ...
      <Link className="link" to="/card-game">
        <div className="header-card">
          <h2>Card Game</h2>
        </div>
      </Link>
      <Link className="link" to="/snl">
        <div className="header-card">
          <h2>Snake & Ladder</h2>
        </div>
      </Link>
      <Link className="link" to="/splitwise">
        <div className="header-card">
          <h2>Spliwise</h2>
        </div>
      </Link>
      <Link className="link" to="/image-gallery">
        <div className="header-card">
          <h2>Image Gallery</h2>
        </div>
      </Link>
